...
<body>
    ...
    <div id="main">
        ...
        <img class="titleImage" src="../image/form/form-gaihaku.png" alt="">
        <form action="../submit/gaihaku.php" method="post">
            ...
            <div class="form-group">
                <p for="place">GoogleMapのURL</p>
                <input type="url" id="mapurl" name="mapurl" required>
            </div>
            <div class="form-group">
                <p for="description">目的・備考</p>
                <textarea id="description" name="description" placeholder="例）SP活動、のような特別なもの" required></textarea>
            </div>
